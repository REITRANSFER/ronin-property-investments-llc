      ...
      <div className="relative z-10">
        ...
        <div className="mx-auto max-w-7xl px-4 py-4 md:py-6 lg:px-8">
          ...
          <div className="mt-8 md:mt-12 mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-1 text-xl font-extrabold text-gray-900 text-balance">
          ...
          {(config.ownerName || config.headshotUrl) && (
            <div className="mt-8 md:mt-12 mx-auto flex flex-col items-center gap-3">
              {config.headshotUrl && (
                <div className="relative h-16 w-16 overflow-hidden rounded-full border-2" style={{ borderColor: "rgba(0,0,0,0.1)" }}>
                  <Image
